...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_12_wasm>", "[int_exprs_12_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.div_s_3", UINT64_C(71))->to_ui64() == UINT32_C(23));
   CHECK(bkend.call_with_return("env", "i64.div_s_3", UINT64_C(3458764513820540928))->to_ui64() == UINT32_C(1152921504606846976));
   CHECK(bkend.call_with_return("env", "i64.div_u_3", UINT64_C(71))->to_ui64() == UINT32_C(23));
   CHECK(bkend.call_with_return("env", "i64.div_u_3", UINT64_C(13835058055282163712))->to_ui64() == UINT32_C(4611686018427387904));
}
...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_13_wasm>", "[int_exprs_13_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.div_s_5", UINT64_C(71))->to_ui64() == UINT32_C(14));
   CHECK(bkend.call_with_return("env", "i64.div_s_5", UINT64_C(5764607523034234880))->to_ui64() == UINT32_C(1152921504606846976));
   CHECK(bkend.call_with_return("env", "i64.div_u_5", UINT64_C(71))->to_ui64() == UINT32_C(14));
   CHECK(bkend.call_with_return("env", "i64.div_u_5", UINT64_C(11529215046068469760))->to_ui64() == UINT32_C(2305843009213693952));
}
...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_14_wasm>", "[int_exprs_14_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.div_s_7", UINT64_C(71))->to_ui64() == UINT32_C(10));
   CHECK(bkend.call_with_return("env", "i64.div_s_7", UINT64_C(8070450532247928832))->to_ui64() == UINT32_C(1152921504606846976));
   CHECK(bkend.call_with_return("env", "i64.div_u_7", UINT64_C(71))->to_ui64() == UINT32_C(10));
   CHECK(bkend.call_with_return("env", "i64.div_u_7", UINT64_C(16140901064495857664))->to_ui64() == UINT32_C(2305843009213693952));
}
...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_15_wasm>", "[int_exprs_15_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.rem_s_3", UINT64_C(71))->to_ui64() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "i64.rem_s_3", UINT64_C(3458764513820540928))->to_ui64() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "i64.rem_u_3", UINT64_C(71))->to_ui64() == UINT32_C(2));
   CHECK(bkend.call_with_return("env", "i64.rem_u_3", UINT64_C(13835058055282163712))->to_ui64() == UINT32_C(0));
}
...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_16_wasm>", "[int_exprs_16_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.rem_s_5", UINT64_C(71))->to_ui64() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "i64.rem_s_5", UINT64_C(5764607523034234880))->to_ui64() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "i64.rem_u_5", UINT64_C(71))->to_ui64() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "i64.rem_u_5", UINT64_C(11529215046068469760))->to_ui64() == UINT32_C(0));
}
...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_17_wasm>", "[int_exprs_17_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.rem_s_7", UINT64_C(71))->to_ui64() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "i64.rem_s_7", UINT64_C(8070450532247928832))->to_ui64() == UINT32_C(0));
   CHECK(bkend.call_with_return("env", "i64.rem_u_7", UINT64_C(71))->to_ui64() == UINT32_C(1));
   CHECK(bkend.call_with_return("env", "i64.rem_u_7", UINT64_C(16140901064495857664))->to_ui64() == UINT32_C(0));
}
...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_3_wasm>", "[int_exprs_3_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.no_fold_shl_shr_u", UINT64_C(9223372036854775808))->to_ui64() == UINT32_C(0));
}
...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_4_wasm>", "[int_exprs_4_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.no_fold_shr_u_shl", UINT64_C(1))->to_ui64() == UINT32_C(0));
}
...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_5_wasm>", "[int_exprs_5_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.no_fold_div_u_mul", UINT64_C(1))->to_ui64() == UINT32_C(0));
}
...
BACKEND_TEST_CASE( "Testing wasm <int_exprs_8_wasm>", "[int_exprs_8_wasm_tests]" ) {
   ...
   CHECK(bkend.call_with_return("env", "i64.no_fold_mul_div_u", UINT64_C(9223372036854775808))->to_ui64() == UINT32_C(0));
}
